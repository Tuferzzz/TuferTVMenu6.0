...
public class UsaParLocksActivity extends BaseActivity {
    ...
    private final int mStartInxForResetStatus = (true == isCustomerUiFlow()) ? 0:3;

    private static int LOCK = 1;

    private static int UNLOCK = 0;

    private boolean isCustomerUiFlow() {
        /*
         * For switching rating control:
         * true: customer UI flow
         * false: Pure SN UI flow
         */
        return false;
    }
            ...
            public void updateUI() {
                ...
                if (LOCK == mCurrValue) {
                    if (true == isCustomerUiFlow()) {
                        ...
                        islock_tv_y7_fv_item.updateUI(LOCK);
                        /* lock TV-Y7 */
                        tvRatingALLList.get(2).updateUI(LOCK);
                    }
        ...
        item = new ImageButtonItem(islock_tv_pg_lImg, mUsaTvRatingInfo.bTV_PG_L_Lock ? LOCK
            ...
            public void updateUI() {
                ...
                if (mCurrValue == LOCK) {
                    ...
                    for (int i = mStartInxForResetStatus; i < tvRatingALLList.size() - 2; i++) {
        ...
        item = new ImageButtonItem(islock_tv_14_lImg, mUsaTvRatingInfo.bTV_14_L_Lock ? LOCK
            ...
            public void updateUI() {
                ...
                if (mCurrValue == LOCK) {
                    ...
                    for (int i = mStartInxForResetStatus; i < tvRatingALLList.size() - 1; i++) {
                        tvRatingALLList.get(i).updateUI(UNLOCK);
                    }
                }
                setALLLock();
        ...
        item = new ImageButtonItem(islock_tv_ma_lImg, mUsaTvRatingInfo.bTV_MA_L_Lock ? LOCK
            ...
            public void updateUI() {
                ...
                if (mCurrValue == UNLOCK) {
                    ...
                    for (int i = mStartInxForResetStatus; i < tvRatingALLList.size(); i++) {
                        tvRatingALLList.get(i).updateUI(UNLOCK);
                    }
                }
                setALLLock();
