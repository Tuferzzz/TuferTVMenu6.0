...
public final class BluetoothDevicePreference extends Preference implements
        CachedBluetoothDevice.Callback, OnClickListener, OnKeyListener {
    ...
    public void onDeviceAttributesChanged() {
         ...
         * changed before proceeding. It will also call notifyChanged() if any
         * preference info has changed from the previous value.
         */
    ...
    protected void onBindView(View view) {
        ...
        if (mCachedDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
            ...
            view.setTag(mCachedDevice);
            view.setAlpha(isEnabled() ? 255 : sDimAlpha);
        }
    ...
    private int getConnectionSummary() {
        ...
        Log.d(TAG, "=====cachedDevice.getProfiles()====="+cachedDevice.getProfiles());
