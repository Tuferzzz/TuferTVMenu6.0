...
/**
 * A2dpProfile handles Bluetooth A2DP. TODO: add null checks around calls to
 * mService object.
 */
final class A2dpProfile implements LocalBluetoothProfile {
    ...
    A2dpProfile(Context context) {
        ...
        adapter.getProfileProxy(context, new A2dpServiceListener(), BluetoothProfile.A2DP);
    }
