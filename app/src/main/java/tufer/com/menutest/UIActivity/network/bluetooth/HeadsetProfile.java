...
final class HeadsetProfile implements LocalBluetoothProfile {
    ...
    HeadsetProfile(Context context, LocalBluetoothAdapter adapter,
            CachedBluetoothDeviceManager deviceManager, LocalBluetoothProfileManager profileManager) {
    ...
    public int getConnectionStatus(BluetoothDevice device) {
        ...
        return !deviceList.isEmpty() && deviceList.get(0).equals(device) ? mService
