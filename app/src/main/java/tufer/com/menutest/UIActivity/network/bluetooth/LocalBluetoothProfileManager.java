...
final class LocalBluetoothProfileManager {
    ...
    private void addPanProfile(LocalBluetoothProfile profile, String profileName,
            String stateChangedAction) {
        mEventManager.addProfileHandler(stateChangedAction, new PanStateChangedHandler(profile));
        mProfileNameMap.put(profileName, profile);
    }
    ...
    synchronized void updateProfiles(ParcelUuid[] uuids, ParcelUuid[] localUuids,
        ...
        if (mHeadsetProfile != null) {
            if ((BluetoothUuid.isUuidPresent(localUuids, BluetoothUuid.HSP_AG) && BluetoothUuid
                    .isUuidPresent(uuids, BluetoothUuid.HSP))
                    || (BluetoothUuid.isUuidPresent(localUuids, BluetoothUuid.Handsfree_AG) && BluetoothUuid
                            .isUuidPresent(uuids, BluetoothUuid.Handsfree))) {
        ...
        if (BluetoothUuid.isUuidPresent(uuids, BluetoothUuid.Hid) && mHidProfile != null) {
            profiles.add(mHidProfile);
            removedProfiles.remove(mHidProfile);
        }

        if (BluetoothUuid.isUuidPresent(uuids, BluetoothUuid.NAP) && mPanProfile != null) {
