...
public class CaEntitleInfoActivity extends Activity {
    ...
    protected Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (msg.what == LittleDownTimer.TIME_OUT_MSG) {
                ...
                Intent intent = new Intent(CaEntitleInfoActivity.this, MainActivity.class);
    ...
    private void getInitData() {
        ...
        if (Entitles.sEntitlesState == CaErrorType.RETURN_CODE.ST_CA_RC_OK.getRetCode()) {
        ...
        } else if (Entitles.sEntitlesState == CaErrorType.RETURN_CODE.ST_CA_RC_CARD_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_card_invalid);
        } else if (Entitles.sEntitlesState == CaErrorType.RETURN_CODE.ST_CA_RC_POINTER_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_pointer_invalid);
        } else if (Entitles.sEntitlesState == CaErrorType.RETURN_CODE.ST_CA_RC_DATA_NOT_FIND.getRetCode()) {
