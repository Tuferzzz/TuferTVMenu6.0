...
public class RecordActivity extends MstarBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initialEpgTimerInfo(targetProgInfo);
        updateUI();
    }
     ...
     */
    private void initialEpgTimerInfo(final ProgramInfo targetProgInfo) {
        ...
        if (mTvSystem == TvCommonManager.TV_SYSTEM_ATSC) {
            mEventTimerInfo.majorNumber = targetProgInfo.majorNum;
            mEventTimerInfo.minorNumber = targetProgInfo.minorNum;
        } else {
