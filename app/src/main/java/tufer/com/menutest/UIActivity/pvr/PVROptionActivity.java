...
package tufer.com.menutest.UIActivity.pvr;
...
public class PVROptionActivity extends MstarBaseActivity {
            ...
            switch (view.getId()) {
                case R.id.pvr_file_system_select_disk: {
                    ...
                    if (usbDriverCount > 0) {
                        ...
                        Toast.makeText(context, R.string.str_pvr_insert_usb, Toast.LENGTH_SHORT)
                                .show();
                        return;
                    }
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usbSelecter = new USBDiskSelecter(this) {
            ...
            public void onItemChosen(int position, String diskLabel, String diskPath) {
                ...
                if (diskLabel.regionMatches(startPos, fat, 0, 3)) {
                    mPvrManager.setPvrParams(diskPath, (short) 2);
                } else if (diskLabel.regionMatches(startPos, ntfs, 0, 4)
                        || !diskLabel.contains(fat)) {
                ...
                if (waitToFormat) {
                     ...
                     * choosed disk
                     */
                    if (diskLabel.regionMatches(startPos, ntfs, 0, 4) || !diskLabel.contains(fat)) {
    ...
    private void formatConfirm() {
        ...
        builder.setMessage(R.string.str_pvr_format_usb)
                .setCancelable(false)
                    ...
                    public void run() {
                        if (result) {
                            ...
                            if (storageManager.mountVolume(path)) {
                                ...
                                selectDisk.setText(usbSelecter.getUsbLabelByPath(path));
                            } else {
