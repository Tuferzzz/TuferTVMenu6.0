...
public class CaWorkTimeActivity extends Activity {
    ...
    protected Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (msg.what == LittleDownTimer.TIME_OUT_MSG) {
                ...
                Intent intent = new Intent(CaWorkTimeActivity.this, MainActivity.class);
    ...
    private void getInitData() {
        ...
        if (worktimeinfo.sWorkTimeState == CaErrorType.RETURN_CODE.ST_CA_RC_OK.getRetCode()) {
        ...
        } else if (worktimeinfo.sWorkTimeState == CaErrorType.RETURN_CODE.ST_CA_RC_CARD_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_card_invalid);
        } else if (worktimeinfo.sWorkTimeState == CaErrorType.RETURN_CODE.ST_CA_RC_POINTER_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_pointer_invalid);
        } else if (worktimeinfo.sWorkTimeState == CaErrorType.RETURN_CODE.ST_CA_RC_UNKNOWN.getRetCode()) {
