...
public class ChannelControlActivity extends MstarBaseActivity {
    ...
    public void onAttachedToWindow() {
        ...
        LinearLayout ll = (LinearLayout) findViewById(R.id.linearlayout_channelcontrol_root);
    ...
    private boolean atscTenKeyCode(int keyCode) {
        ...
        if (mInputKeySlash == true) {
            ...
            ttsStr = mChannelNumberInput + "-" + mChannelNumberMinorNum;
        }
        mTvCommonManager.speakTtsDelayed(ttsStr, TvCommonManager.TTS_QUEUE_FLUSH,
                TvCommonManager.TTS_SPEAK_PRIORITY_NORMAL, TvCommonManager.TTS_DELAY_TIME_NO_DELAY);
    ...
    private void updateAtvTuningScanInfo(AtvEventScan extra) {
        ...
        if (extra.scannedChannelNum > 0) {
            ...
            if (mTvSystem == TvCommonManager.TV_SYSTEM_ISDB) {
                int maxCh = mTvChannelManager.getProgramCtrl(
