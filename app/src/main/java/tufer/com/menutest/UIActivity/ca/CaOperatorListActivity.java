...
public class CaOperatorListActivity extends Activity implements OnItemSelectedListener,
    ...
    protected Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (msg.what == LittleDownTimer.TIME_OUT_MSG) {
                ...
                Intent intent = new Intent(CaOperatorListActivity.this, MainActivity.class);
    ...
    protected void onResume() {
        Log.d(TAG, "CaOperatorListActivity onResume");
    ...
    protected void onPause() {
        Log.d(TAG, "CaOperatorListActivity onPause");
    ...
    public void onUserInteraction() {
        Log.d(TAG, "CaOperatorListActivity onUserInteraction");
    ...
    private void getInitData() {
        ...
        if (OperatorIds.sOperatorIdState == CaErrorType.RETURN_CODE.ST_CA_RC_OK.getRetCode()) {
        ...
        } else if (OperatorIds.sOperatorIdState == CaErrorType.RETURN_CODE.ST_CA_RC_CARD_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_card_invalid);
        } else if (OperatorIds.sOperatorIdState == CaErrorType.RETURN_CODE.ST_CA_RC_POINTER_INVALID
                .getRetCode()) {
