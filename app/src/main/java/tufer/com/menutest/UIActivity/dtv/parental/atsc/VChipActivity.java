...
package tufer.com.menutest.UIActivity.dtv.parental.atsc;
...
import tufer.com.menutest.UIActivity.component.PasswordChangeDialog;
...
public class VChipActivity extends MstarBaseActivity {
    ...
    private void initItems() {
        ...
        mPasswordChange = new PasswordChangeDialog(VChipActivity.this, R.layout.password_change_dialog_6_digits) {
            @Override
        ...
        if ((curSource == TvCommonManager.INPUT_SOURCE_ATV || manager.getRRT5NoDimension() <= 0 || !mFocus)) {
            mFlag = false;
        }
    }
    ...
    public void updateUI() {
        ...
        if (TvCommonManager.INPUT_SOURCE_ATV == curSource || manager.getRRT5NoDimension() <= 0 || false == mFocus) {
            mFlag = false;
        }
