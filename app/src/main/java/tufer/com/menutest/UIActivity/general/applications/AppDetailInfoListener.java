...
public class AppDetailInfoListener {

    private AppDetailInfoActivity mAppDetailInfoActivity;

    private AppDetailInfoViewHolder mAppDetailInfoViewHolder;

    public AppDetailInfoListener(AppDetailInfoActivity activity, AppDetailInfoViewHolder holder) {
        this.mAppDetailInfoActivity = activity;
        this.mAppDetailInfoViewHolder = holder;
    ...
    private void registerListeners() {
        mAppDetailInfoViewHolder.open_app.setOnClickListener(new View.OnClickListener() {
    ...
    public void setInvisible() {
        mAppDetailInfoViewHolder.totalLayout.setVisibility(View.INVISIBLE);
        mAppDetailInfoViewHolder.appLayout.setVisibility(View.INVISIBLE);
        mAppDetailInfoViewHolder.dataLayout.setVisibility(View.INVISIBLE);
        mAppDetailInfoViewHolder.cacheLayout.setVisibility(View.INVISIBLE);
    ...
    private void showToast(int id) {
        ...
        Toast.makeText(mAppDetailInfoActivity, mAppDetailInfoActivity.getString(id),
