...
public abstract class USBDiskSelecter {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    msg.arg1 = (int) (100 - ((sf.getFreeBlocksLong() * 100) / sf
                            .getBlockCountLong()));
    ...
    private boolean getChooseDiskSettings() {
        SharedPreferences sp = context.getSharedPreferences(Constant.SAVE_SETTING_SELECT,
        ...
        if (file.isDirectory()) {
            ...
            for (File tmp : list) {
                if (isFileExisted(tmp.getAbsolutePath() + "/_MSTPVR/")
                        || tufer.com.menutest.UIActivity.pvr.USBBroadcastReceiver
    ...
    public String getBestDiskPath() {
        if (getChooseDiskSettings()) {
            ...
            if (isFileExisted(path + "/_MSTPVR")
                    || tufer.com.menutest.UIActivity.pvr.USBBroadcastReceiver.isDiskExisted(path)) {
                return path;
            } else {
