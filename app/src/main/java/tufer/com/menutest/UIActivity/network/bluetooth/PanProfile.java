...
final class PanProfile implements LocalBluetoothProfile {
    ...
    private final HashMap<BluetoothDevice, Integer> mDeviceRoleMap = new HashMap<BluetoothDevice, Integer>();
    ...
    PanProfile(Context context) {
        ...
        adapter.getProfileProxy(context, new PanServiceListener(), BluetoothProfile.PAN);
    }
