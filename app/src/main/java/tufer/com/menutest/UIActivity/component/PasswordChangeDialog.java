...
public class PasswordChangeDialog {
    ...
    public PasswordChangeDialog(Activity activity, int viewResId) {
        mActivity = activity;
        mDialog = new Dialog(mActivity, R.style.dialog);
        mDialog.setContentView(viewResId);
    ...
    private void initItems() {
        mToast = Toast.makeText(mActivity, STR_EMPTY , Toast.LENGTH_SHORT);
    ...
    private void setListeners() {
            ...
            public void onFocusChange(View view, boolean bHasFocus) {
                if (true == bHasFocus) {
                    ((LinearLayout)view.getParent()).setBackgroundResource(R.drawable.round_corner_hollow_focused);
                        Utility.ttsSepakLinearLayout((LinearLayout)view.getParent());
                } else {
        ...
        btnChangePasswordApply.setOnFocusChangeListener(buttonFocusChangeListener);
        btnChangePasswordCancel.setOnFocusChangeListener(buttonFocusChangeListener);
        btnChangePasswordReset.setOnFocusChangeListener(buttonFocusChangeListener);
    ...
    private void changePassword() {
       ...
       if (null != mToast) {
        ...
        if (null == oldPassword || oldPassword.length() < ((ViewGroup)mlinearOldPasswordGroup).getChildCount()) {
            mToast = Toast.makeText(mActivity, mActivity.getResources().getString(R.string.old_password_not_filled_completely) , Toast.LENGTH_LONG);
            mToast.show();
        } else if (null == newPassword || newPassword.length() < ((ViewGroup)mlinearNewPasswordGroup).getChildCount()) {
            mToast = Toast.makeText(mActivity, mActivity.getResources().getString(R.string.new_password_not_filled_completely) , Toast.LENGTH_LONG);
            mToast.show();
        } else if (false == oldPassword.equals(currentPassword)) {
            mToast = Toast.makeText(mActivity, mActivity.getResources().getString(R.string.originalpassworderr) , Toast.LENGTH_LONG);
            mToast.show();
        } else if (false == newPassword.equals(confirmPassword)) {
            mToast = Toast.makeText(mActivity, mActivity.getResources().getString(R.string.newconfirmpassworderr) , Toast.LENGTH_LONG);
            mToast.show();
        } else if (true == oldPassword.equals(currentPassword) && true == newPassword.equals(confirmPassword)) {
