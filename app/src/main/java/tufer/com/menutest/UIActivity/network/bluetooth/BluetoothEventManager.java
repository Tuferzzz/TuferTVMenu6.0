...
final class BluetoothEventManager {
    ...
    private class AdapterStateChangedHandler implements Handler {
        public void onReceive(Context context, Intent intent, BluetoothDevice device) {
            ...
            Log.d(TAG, "mLocalAdapter=============>"+mLocalAdapter.toString());
    ...
    private void dispatchDeviceAdded(CachedBluetoothDevice cachedDevice) {
        synchronized (mCallbacks) {
        	Log.d(TAG, "mCallbacks========>"+mCallbacks.toString());
        	Log.d(TAG, "cachedDevice"+cachedDevice.toString());
            for (BluetoothCallback callback : mCallbacks) {
    ...
    boolean readPairedDevices() {
        ...
        //Log.d(TAG, "bondedDevices=======>"+bondedDevices.toString());
