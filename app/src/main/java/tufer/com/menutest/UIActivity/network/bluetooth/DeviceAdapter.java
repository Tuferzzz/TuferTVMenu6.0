...
public class DeviceAdapter extends BaseAdapter {
    ...
    public DeviceAdapter(Context context, List<BluetoothDevice> BlueToothDeviceList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView addressName = (TextView) view.findViewById(R.id.device_address);
        deviceName.setText(blueToothDevice.getName());
        addressName.setText(blueToothDevice.getAddress());
