...
public class CycleScrollView extends ScrollView {
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (currentFocused instanceof LinearLayout) {
                ttsSepakLinearLayout((LinearLayout) currentFocused);
            }
        };
    };
    /**
                            ...
                            case KeyEvent.KEYCODE_DPAD_UP:
                                ...
                                if (true == ret) {
                                    ...
                                    if (nextFocused instanceof LinearLayout) {
                                        ...
                                        ttsSepakLinearLayout((LinearLayout) nextFocused);
                                    }
                                }
                                return ret;
    ...
    private void ttsSepakLinearLayout(LinearLayout ll) {
        int id = ll.getId();
        if (id != mTtsLlId) {
            mTtsLlId = id;
