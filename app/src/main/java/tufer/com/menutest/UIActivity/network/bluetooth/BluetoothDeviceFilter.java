...
/**
 * BluetoothDeviceFilter contains a static method that returns a Filter object
 * that returns whether or not the BluetoothDevice passed to it matches the
 * specified filter type constant from
...
final class BluetoothDeviceFilter {
    ...
    private static final class TransferFilter extends ClassUuidFilter {
        ...
        boolean matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            ...
            return btClass != null && btClass.doesClassMatch(BluetoothClass.PROFILE_OPP);
        }
    }
    ...
    private static final class PanuFilter extends ClassUuidFilter {
        ...
        boolean matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            ...
            return btClass != null && btClass.doesClassMatch(BluetoothClass.PROFILE_PANU);
        }
    }
    ...
    private static final class NapFilter extends ClassUuidFilter {
        ...
        boolean matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            ...
            return btClass != null && btClass.doesClassMatch(BluetoothClass.PROFILE_NAP);
        }
    }
}
