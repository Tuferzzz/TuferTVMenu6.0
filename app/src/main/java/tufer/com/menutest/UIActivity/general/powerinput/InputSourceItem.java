...
public class InputSourceItem {
    ...
    private EnumUserDefinedType userDefineItemType = EnumUserDefinedType.E_DEFINED_NONE;
    ...
    public EnumUserDefinedType getUserDefineItemType() {
        return userDefineItemType;
    }

    public void setUserDefineItemType(EnumUserDefinedType type) {
        this.userDefineItemType = type;
    }

    public boolean isUserDefineItem() {
        if (userDefineItemType != EnumUserDefinedType.E_DEFINED_NONE) {
            return true;
        } else {
            return false;
        }
