...
public class PackageSizeObserver extends IPackageStatsObserver.Stub {
    ...
    private static final String TAG = "MSettings.PackageSizeObserver";
    private static final int REFRESH_APP_SIZE = 3;

    private ApplicationInformation mAppInfo;
    private Handler mAppInfoHandler;
    // for all size info
    ...
    public PackageSizeObserver(ApplicationInformation mAppInfor, Handler handler) {
        this.mAppInfo = mAppInfor;
        this.mAppInfoHandler = handler;
    }

    @Override
    public void onGetStatsCompleted(PackageStats pStats, boolean succeeded) throws RemoteException {
        Log.d(TAG, "packageStats, " + pStats.toString());
