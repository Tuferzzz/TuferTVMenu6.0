...
public class CaDetitleInfoActivity extends Activity {
    ...
    protected Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (msg.what == LittleDownTimer.TIME_OUT_MSG) {
                ...
                Intent intent = new Intent(CaDetitleInfoActivity.this, MainActivity.class);
    ...
    private void getInitData() {
        ...
        int bb = CaErrorType.RETURN_CODE.ST_CA_RC_DATA_NOT_FIND.getRetCode();
        if (DetitleChkNums.sDetitleChkNumsState == CaErrorType.RETURN_CODE.ST_CA_RC_OK.getRetCode()) {
        ...
        } else if (DetitleChkNums.sDetitleChkNumsState == CaErrorType.RETURN_CODE.ST_CA_RC_CARD_INVALID
                .getRetCode()) {
            toastShow(R.string.st_ca_rc_card_invalid);
        } else if (DetitleChkNums.sDetitleChkNumsState == CaErrorType.RETURN_CODE.ST_CA_RC_POINTER_INVALID
                .getRetCode()) {
            toastShow(R.string.st_ca_rc_pointer_invalid);
        } else if (DetitleChkNums.sDetitleChkNumsState == CaErrorType.RETURN_CODE.ST_CA_RC_DATA_NOT_FIND
                .getRetCode()) {
