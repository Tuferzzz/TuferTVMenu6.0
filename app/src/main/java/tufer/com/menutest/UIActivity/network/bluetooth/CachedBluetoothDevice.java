...
final class CachedBluetoothDevice implements Comparable<CachedBluetoothDevice> {
    ...
    void onProfileStateChanged(LocalBluetoothProfile profile, int newProfileState) {
        if (Utils.D) {
            Log.d(TAG, "onProfileStateChanged: profile " + profile + " newProfileState "
                    + newProfileState);
        }
    ...
    int getProfileConnectionState(LocalBluetoothProfile profile) {
        if (mProfileConnectionState == null || mProfileConnectionState.get(profile) == null) {
        	...
        	Log.d(TAG, "mDevice***********"+mDevice.toString());
    ...
    void setPhonebookPermissionChoice(int permissionChoice) {
        SharedPreferences.Editor editor = mContext.getSharedPreferences(PHONEBOOK_PREFS_NAME,
