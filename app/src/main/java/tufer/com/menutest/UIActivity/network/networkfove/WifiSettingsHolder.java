...
public class WifiSettingsHolder {
    ...
    public WifiSettingsHolder(NetworkSettingsActivity networkSettingActivity) {
    ...
    private void findViews() {
        // root layout
        mWifiSettingsRootLayout = (LinearLayout) getViewById(R.id.wireless_setting_ll);
        // wifi toggle
        mWifiToggleLayout = (RelativeLayout) getViewById(R.id.wifi_switch_rl);
        mWifiSwitchChbox = (CheckBox) getViewById(R.id.wifi_switch_checkbox);
        // listview contain wifi signal
        mWifiListView = (ListView) getViewById(R.id.wifi_ssid_listview);
        mWifiListView.setDividerHeight(0);
        // footer view of listview
        LayoutInflater factory = LayoutInflater.from(mNetworkSettingActivity);
