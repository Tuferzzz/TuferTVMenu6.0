...
public class CheckParentalPwdActivity extends MstarBaseActivity {
    ...
    private void checkpsw() {
        ...
        if (false == isValid) {
            ...
            intent.putExtra("currentPage", ChannelActivity.OPTION_PAGE);
        ...
        if (result) {
            ...
            switch (list) {
                ...
                case 2:
                    if (true == Utility.isSupportATV()) {
                        if (TvCommonManager.getInstance().isSupportModule(TvCommonManager.MODULE_ATV_NTSC_ENABLE)) {
                            intent.setClass(this, NTSCATVManualTuning.class);
                        } else if (TvCommonManager.getInstance().isSupportModule(TvCommonManager.MODULE_ATV_PAL_ENABLE)) {
                            intent.setClass(this, PALATVManualTuning.class);
                        } else {
                ...
                case 3:
                    ...
                    //MainActivity.setRebootFlag(true);
                ...
                case 6:
                    ...
                    intent2.putExtra("currentPage", ChannelActivity.LOCK_PAGE);
                    if (intent.resolveActivity(getPackageManager()) != null) {
