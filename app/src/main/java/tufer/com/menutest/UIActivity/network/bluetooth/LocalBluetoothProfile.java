...
/**
 * LocalBluetoothProfile is an interface defining the basic functionality
 * related to a Bluetooth profile.
 */
interface LocalBluetoothProfile {
    ...
    /**
     * Returns the string resource ID for the summary text for this profile for
     * the specified device, e.g. "Use for media audio" or
