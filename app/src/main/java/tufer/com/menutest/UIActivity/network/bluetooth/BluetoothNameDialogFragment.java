...
public final class BluetoothNameDialogFragment extends DialogFragment implements TextWatcher {
    ...
    // This flag is set when the name is updated by code, to distinguish from
    // user changes
    ...
    private View createDialogView(String deviceName) {
        ...
        mDeviceNameView.setText(deviceName); // set initial value before adding
                                             // listener
    ...
    public void onResume() {
        ...
        if (mOkButton == null) {
            ...
            mOkButton.setEnabled(mDeviceNameEdited); // Ok button enabled after
                                                     // user edits
        }
    ...
    public void afterTextChanged(Editable s) {
        if (mDeviceNameUpdated) {
            // Device name changed by code; disable Ok button until edited by
            // user
