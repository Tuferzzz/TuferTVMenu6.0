...
import tufer.com.menutest.UIActivity.tuning.dvb.TargetRegionListDialog;
import tufer.com.menutest.UIActivity.tuning.dvb.RegionChannelListIfnoDialog;
...
public class ChannelTuning extends MstarBaseActivity {
    ...
    private static final String TAG = "TuferChannelTuning";
    ...
    private class DtvScanEventListener implements OnDtvScanEventListener {
        ...
        public boolean onDtvScanEvent(int what, int arg1, int arg2, Object info) {
            Log.d(TAG,TAG+" DtvScanEventListener");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDtvUiEventHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                Log.d(TAG,TAG+" updateDtvTuningScanInfo");
        ...
        if ((getIntent() != null) && (getIntent().getExtras() != null)) {
            ...
            Log.d(TAG,"isDtvAutoUpdateScan="+isDtvAutoUpdateScan);
        }
        ...
        if (isDtvAutoUpdateScan) {
            ...
            Log.d(TAG,"mTvChannelManager.getUserScanType()="+mTvChannelManager.getUserScanType());
    ...
    protected void onResume() {
        Log.d(TAG, String.valueOf(Utility.isTopActivity(this, "com.mstar.tv.tvplayer.ui.RootActivity")));
    ...
    private void updateDtvTuningScanInfo(DtvEventScan extra) {
        ...
        if (TvChannelManager.DTV_SCAN_STATUS_AUTOTUNING_PROGRESS == scan_status) {
            ...
            if (isVHF) {
                ...
                Log.e(TAG, "TvCommonManager.TV_SYSTEM_ATSC-----  " );
            ...
            if (mTvSystem == TvCommonManager.TV_SYSTEM_ATSC) {
                if (dtv != mDtvCount) {
                    Log.e(TAG, "TvCommonManager.TV_SYSTEM_ATSC  " + scan_status);
                    ttsSepakTuningStatus();
                }
                mDtvCount = dtv;
            }
