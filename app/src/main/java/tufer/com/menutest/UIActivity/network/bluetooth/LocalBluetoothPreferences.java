...
/**
 * LocalBluetoothPreferences provides an interface to the preferences related to
 * Bluetooth.
 */
final class LocalBluetoothPreferences {
    ...
    static boolean getDockAutoConnectSetting(Context context, String addr) {
        return getSharedPreferences(context).getBoolean(KEY_DOCK_AUTO_CONNECT + addr, false);
    }
