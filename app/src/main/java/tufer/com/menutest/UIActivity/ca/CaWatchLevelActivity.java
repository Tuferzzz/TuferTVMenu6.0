...
public class CaWatchLevelActivity extends Activity {
    ...
    protected Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (msg.what == LittleDownTimer.TIME_OUT_MSG) {
                ...
                Intent intent = new Intent(CaWatchLevelActivity.this, MainActivity.class);
    ...
    private void getInitData() {
        ...
        if (ratinginfo.sRatingState == CaErrorType.RETURN_CODE.ST_CA_RC_OK.getRetCode()) {
        ...
        } else if (ratinginfo.sRatingState == CaErrorType.RETURN_CODE.ST_CA_RC_CARD_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_card_invalid);
        } else if (ratinginfo.sRatingState == CaErrorType.RETURN_CODE.ST_CA_RC_POINTER_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_pointer_invalid);
        } else if (ratinginfo.sRatingState == CaErrorType.RETURN_CODE.ST_CA_RC_UNKNOWN.getRetCode()) {
    ...
    private void modifyWatchLevel() {
        ...
        if (ret == CaErrorType.RETURN_CODE.ST_CA_RC_OK.getRetCode()) {
            toastShow(R.string.st_ca_rc_ok);
        } else if (ret == CaErrorType.RETURN_CODE.ST_CA_RC_CARD_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_card_invalid);
        } else if (ret == CaErrorType.RETURN_CODE.ST_CA_RC_POINTER_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_pointer_invalid);
        } else if (ret == CaErrorType.RETURN_CODE.ST_CA_RC_PIN_INVALID.getRetCode()) {
            toastShow(R.string.st_ca_rc_pin_invalid);
        } else if (ret == CaErrorType.RETURN_CODE.ST_CA_RC_UNKNOWN.getRetCode()) {
            toastShow(R.string.st_ca_rc_unknown);
        } else if (ret == CaErrorType.RETURN_CODE.ST_CA_RC_WATCHRATING_INVALID.getRetCode()) {
