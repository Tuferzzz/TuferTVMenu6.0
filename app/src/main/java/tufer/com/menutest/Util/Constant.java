...
public class Constant {
    ...
    public static final String PREFERENCES_IS_EWBS_AREA_CODE_SELECTED = "areaCodeSelected";
    ...
    public static final int ROOTACTIVITY_TTS_SPEAK_NO_SIGNAL_STATUS = 8002;

    public static final int ROOTACTIVITY_DELAY_TO_CLOSE_DIALOG = 8003;

    public static final int ROOTACTIVITY_DISPLAY_RESOURCE_CONFLICT_DIALOG = 8004;
    ...
    public static final int TTS_CHANNEL_NAME_MAX_LENGTH = 80;

    public static final int TTS_EVENT_NAME_MAX_LENGTH = 80;
    ...
    /*
     * PVR PVR_CREATE_MODE extra int contant, schedule record or one touch
     * record
     */
