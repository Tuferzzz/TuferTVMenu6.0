...
public class TvIntent {
    public static final String MENU = "tufer.com.menutest.UIActivity.intent.action.MAINMENU";//ok

    public static final String MAINMENU = "tufer.com.menutest.UIActivity.intent.action.CHANNELMENU";//ok
    ...
    public static final String CHANNEL_LIST = "tufer.com.menutest.UIActivity.intent.action.CHANNEL_LIST";//ok

    public static final String CHANNEL_CONTROL = "tufer.com.menutest.UIActivity.intent.action.CHANNEL_CONTROL";//ok
    ...
    public static final String ACTION_SOURCEINFO = "tufer.com.menutest.UIActivity.intent.action.SOURCE_INFO";//ok

    public static final String ACTION_SOURCE_INFO_DISAPPEAR = "source_info_disappear";

    public static final String ACTION_AUTOTUNING_OPTION = "tufer.com.menutest.UIActivity.intent.action.AUTOTUNING_OPTION";//ok

    public static final String ACTION_DVBSDTV_AUTOTUNING_OPTION = "tufer.com.menutest.UIActivity.intent.action.DVBSDTV_AUTOTUNING_OPTION";//ok

    public static final String ACTION_CHANNEL_TUNING = "tufer.com.menutest.UIActivity.intent.action.CHANNEL_TUNING";//ok

    public static final String ACTION_DTV_MANUAL_TUNING = "tufer.com.menutest.UIActivity.intent.action.DTV_MANUAL_TUNING";//ok

    public static final String ACTION_NTSC_ATV_MANUAL_TUNING = "tufer.com.menutest.UIActivity.intent.action.NTSC_ATV_MANUAL_TUNING";//ok

    public static final String ACTION_PAL_ATV_MANUAL_TUNING = "tufer.com.menutest.UIActivity.intent.action.PAL_ATV_MANUAL_TUNING";//ok

    public static final String ACTION_VCHIP_ACTIVITY = "com.mstar.tv.tvplayer.ui.intent.action.VCHIP_ACTIVITY";

    public static final String ACTION_LNBSETTING = "tufer.com.menutest.UIActivity.intent.action.LnbSetting";//ok

    public static final String ACTION_LNBOPTION = "tufer.com.menutest.UIActivity.intent.action.LnbOption";//ok

    public static final String ACTION_LNBOPTION_EDITOR = "tufer.com.menutest.UIActivity.intent.action.LnbOptionEditor";//ok

    public static final String ACTION_LNBMOTOR_EDITOR = "tufer.com.menutest.UIActivity.intent.action.LnbMotorEditor";//ok

    public static final String ACTION_SETUP_WIZARD = "com.mstar.tv.tvplayer.ui.intent.action.SETUP_WIZARD";

    public static final String ACTION_EPG_ACTIVITY = "tufer.com.menutest.UIActivity.intent.action.EPG_ACTIVITY";//ok

    public static final String ACTION_EPG_REMINDER = "tufer.com.menutest.UIActivity.intent.action.EPG_REMINDER";//ok

    public static final String ACTION_PVR_ACTIVITY = "tufer.com.menutest.UIActivity.intent.action.PVR_ACTIVITY";//ok
    ...
    public static final String ACTION_TV_TIME_ZONE_CHANGE = "tufer.com.menutest.UIActivity.intent.action.TV_TIME_ZONE_CHANGE";//ok
