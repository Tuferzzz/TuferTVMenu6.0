...
public class PreferancesTools {
    ...
    public static final String DISCOVERABLE_END_TIMESTAMP = "discoverable_end_timestamp";

    public static final String SYSTEM_PROPERTY_DISCOVERABLE_TIMEOUT = "system_property_discoverable_timeout";

    public static final String VOICE_EFFECT = "voice_effect";
